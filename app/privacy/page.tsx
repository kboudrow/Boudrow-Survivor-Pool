...
export const metadata = {
  ...
  description: 'Privacy Policy for Survive Sunday accounts, picks, ads, cookies, and pool history.',
}
      ...
      <div className="mx-auto w-full max-w-3xl">
        ...
        <nav className="mt-8 rounded-lg border border-slate-200 p-4">
          ...
          <ul className="space-y-1 text-sm text-slate-700">
            ...
            <li><a className="underline" href="#ads">6. Ads, analytics, and cookies</a></li>
            <li><a className="underline" href="#retention">7. Data retention</a></li>
            <li><a className="underline" href="#choices">8. Your choices and rights</a></li>
            <li><a className="underline" href="#security">9. Security</a></li>
            <li><a className="underline" href="#children">10. Children&apos;s privacy</a></li>
            <li><a className="underline" href="#changes">11. Changes</a></li>
        ...
        <p className="mt-3 leading-7 text-slate-700">
          ...
          It applies to our website, app pages, account features, pool dashboards, and related services.
        </p>
        ...
        <ul className="mt-3 list-disc space-y-1 pl-5 leading-7 text-slate-700">
          ...
          <li>Respond to support, account, and privacy questions.</li>
        ...
        <ul className="mt-2 list-disc space-y-1 pl-5 leading-7 text-slate-700">
          <li><span className="font-medium">With service providers</span> that help operate the Service, such as Supabase, Vercel, Google, email/auth providers, analytics, ads, security, and support tools.</li>
        ...
        <SectionTitle id="ads">6. Ads, analytics, and cookies</SectionTitle>
        <p className="mt-3 leading-7 text-slate-700">
        ...
        <SectionTitle id="choices">8. Your choices and rights</SectionTitle>
        <p className="mt-3 leading-7 text-slate-700">
        ...
        <SectionTitle id="changes">11. Changes</SectionTitle>
        <p className="mt-3 leading-7 text-slate-700">
